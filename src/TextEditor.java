...
class TextEditor {
    public static void main(String[] args) throws Exception{
        ...
        while(sc.hasreadString()) {//cambio a input
            String line=sc.readString();//cambio a input
        ...
        Input sc = new Input();//cambio a input
        while(true)
        {
            ...
            edit.printCursor();
            String input;
            input = sc.readString();//cambio a input
            ...
            else if(input.equals("i")) edit.insert(sc.readString());//cambio a input
